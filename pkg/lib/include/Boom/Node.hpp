...
public:
    ...
    boom::Emitter<boom::NodeRef> onDetach;
    boom::Emitter<boom::NodeRef> onResize;
    boom::Emitter<boom::NodeRef> onUpdate;
    boom::Emitter<boom::NodeRef> onRender;
    boom::Emitter<boom::NodeRef, boom::Vec2, boom::KeyModifiers> onMouseMove;
    boom::Emitter<boom::NodeRef, boom::Vec2, boom::KeyModifiers> onMouseEnter;
    boom::Emitter<boom::NodeRef, boom::Vec2, boom::KeyModifiers> onMouseExit;
    boom::Emitter<boom::NodeRef, boom::Vec2, boom::KeyModifiers> onMouseWheel;
    boom::Emitter<boom::NodeRef, boom::Vec2, boom::KeyModifiers> onMouseClick;
    boom::Emitter<boom::NodeRef, boom::Vec2, boom::KeyModifiers> onLButtonDown;
    boom::Emitter<boom::NodeRef, boom::Vec2, boom::KeyModifiers> onRButtonDown;
    boom::Emitter<boom::NodeRef, boom::Vec2, boom::KeyModifiers> onLButtonUp;
    boom::Emitter<boom::NodeRef, boom::Vec2, boom::KeyModifiers> onRButtonUp;
    boom::Emitter<boom::NodeRef, boom::Key, boom::KeyModifiers, std::string const&> onKeyDown;
    boom::Emitter<boom::NodeRef, boom::Key, boom::KeyModifiers, std::string const&> onKeyUp;
    boom::Emitter<boom::NodeRef> onFocus;
    boom::Emitter<boom::NodeRef> onBlur;
...
private:
    ...
    void _mouseClick(boom::Vec2, boom::KeyModifiers);
